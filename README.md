...
In the digital age we're all appropriation artists. Or Pig-Pen from Peanuts. As Pigpen moves through the world, he inscribes the contemporary into his digital cloud, adding the dirt of the day to his already thickly layered historical record. As an outcast, he assumes the role of the trickster, a figure who, defying normative community-based behavioral standards, is the keeper of a database of deep and secret knowledge. His cloud is a haze, an ambience, a network that can’t be defined by specific boundaries. He is at once physical and ephemeral.<br><br>
